...
In the representation of zippers I chose, I explicitly separate the information for a node
...
First, I define a type `Costep` that contains contextual information about
